namespace RecipeManagement.UnitTests.UnitTests.Domain.UserProfiles;

using RecipeManagement.SharedTestHelpers.Fakes.UserProfile;
using RecipeManagement.Domain.UserProfiles;
using RecipeManagement.Domain.UserProfiles.DomainEvents;
using Bogus;
